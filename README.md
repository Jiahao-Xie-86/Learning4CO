# Awesome ML4CO — Unified Literature List

Personal curated list merging **classical ML for combinatorial optimization** (by problem) with a dedicated **LLM for combinatorial optimization** section up front. Entries may appear in both the LLM block and a problem section when relevant.

**Sources & inspiration:** structure and many entries from [Thinklab-SJTU/awesome-ml4co](https://github.com/Thinklab-SJTU/awesome-ml4co); LLM-focused line of work overlaps with [ai4co/awesome-fm4co](https://github.com/ai4co/awesome-fm4co) (cite and extend as you prefer).

Papers with ⭐ are from [Thinklab, SJTU](http://thinklab.sjtu.edu.cn).

## [Content](#content)

<table>
<tr><td colspan="2"><a href="#llm-for-combinatorial-optimization">1. LLM for Combinatorial Optimization</a></td></tr>
<tr><td colspan="2"><a href="#survey-papers">2. Survey</a></td></tr>
<tr><td colspan="2"><a href="#problems">3. Problems</a></td></tr>
<tr>
...
1. **Large Language Models as End-to-end Combinatorial Optimization Solvers** NeurIPS, 2025. [paper](https://neurips.cc/virtual/2025/loc/san-diego/poster/115835), [code](https://github.com/Summer142857/LLMCoSolver)

    *Xia Jiang, Yaoxin Wu, Minshuo Li, Zhiguang Cao, Yingqian Zhang*

2. **Generalizable Heuristic Generation Through LLMs with Meta-Optimization** ICLR, 2026. [paper](https://arxiv.org/abs/2505.20881), [code](https://github.com/yiding-s/MoH)
...
4. **Bridging Synthetic and Real Routing Problems via LLM-Guided Instance Generation and Progressive Adaptation** AAAI, 2026. [paper](https://arxiv.org/abs/2511.10233), [code](https://github.com/HenryZhu1029/EvoReal)
...
6. **Refining Hybrid Genetic Search for CVRP via Reinforcement Learning-Finetuned LLM** ICLR, 2026. [paper](https://arxiv.org/abs/2510.11121), [code](https://github.com/zaodushi/RFTHGS)

    *Rongjie Zhu, Cong Zhang, Zhiguang Cao*

7. **An Agentic Framework with LLMs for Solving Complex Vehicle Routing Problems** ICLR, 2026. [paper](https://openreview.net/forum?id=BMOgYw4EhQ), [code](https://github.com/ZHANG-NI/AFL)

    *Ni Zhang, Zhiguang Cao, Jianan Zhou, Cong Zhang, Yew-Soon Ong*

8. **G-LNS: Generative Large Neighborhood Search for LLM-Based Automatic Heuristic Design** Arxiv, 2026. [paper](https://arxiv.org/abs/2602.08253), [code](https://github.com/ZBoyn/G-LNS)

    *Baoyun Zhao, He Wang, Liang Zeng*

9. **ViTSP: A Vision Language Models Guided Framework for Solving Large-Scale Traveling Salesman Problems** ICLR, 2026. [paper](https://arxiv.org/abs/2509.23465), [code](https://github.itap.purdue.edu/uSMART/ViTSP_ICLR2026)
